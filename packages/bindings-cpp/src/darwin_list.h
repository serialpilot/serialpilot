#ifndef PACKAGES_BINDINGS_CPP_SRC_DARWIN_LIST_H_
#define PACKAGES_BINDINGS_CPP_SRC_DARWIN_LIST_H_
...
struct ListBaton : public Napi::AsyncWorker {
  ListBaton(Napi::Function& callback) : Napi::AsyncWorker(callback, "serialpilot:ListBaton"), 
  errorString() {}
...
#endif  // PACKAGES_BINDINGS_CPP_SRC_DARWIN_LIST_H_
