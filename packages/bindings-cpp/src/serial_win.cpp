...
void OpenBaton::Execute() {
  ...
  if (rtscts) {
    switch (rtsMode) {
      case BINDING_RTSMODE_ENABLE:
        dcb.fRtsControl = RTS_CONTROL_ENABLE;
        break;
      case BINDING_RTSMODE_HANDSHAKE:
        dcb.fRtsControl = RTS_CONTROL_HANDSHAKE;
        break;
      case BINDING_RTSMODE_TOGGLE:
  ...
  switch (parity) {
  case BINDING_PARITY_NONE:
    dcb.Parity = NOPARITY;
    break;
  case BINDING_PARITY_MARK:
    dcb.Parity = MARKPARITY;
    break;
  case BINDING_PARITY_EVEN:
    dcb.Parity = EVENPARITY;
    break;
  case BINDING_PARITY_ODD:
    dcb.Parity = ODDPARITY;
    break;
  case BINDING_PARITY_SPACE:
    dcb.Parity = SPACEPARITY;
    break;
  }

  switch (stopBits) {
  case BINDING_STOPBITS_ONE:
    dcb.StopBits = ONESTOPBIT;
    break;
  case BINDING_STOPBITS_ONE_FIVE:
    dcb.StopBits = ONE5STOPBITS;
    break;
  case BINDING_STOPBITS_TWO:
