...
import { binding } from './native-bindings'

const { Poller: PollerBindings } = binding as { Poller: PollerClass }
const logger = debug('serialpilot/bindings-cpp/poller')
...
/**
 * Polls unix systems for readable or writable states of a file or serial port
 */
