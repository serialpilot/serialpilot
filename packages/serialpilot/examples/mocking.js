// Load SerialPilot with mock bindings
const { SerialPilotMock, SerialPilotError } = require('serialpilot')
const { MockBinding } = SerialPilotMock
...
const port = new SerialPilotMock({ path: portPath, baudRate: 9600 })
port.on('open', () => {
